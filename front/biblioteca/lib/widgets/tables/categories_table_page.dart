...
class _CategoriesTablePageState extends State<CategoriesTablePage> {
  ...
  Material getPage() {
    ...
    List<Categoria> users = provider.categorias;
    ...
    List<Categoria> paginatedCategorias = users.sublist(startIndex, endIndex);
                        ...
                        children: [
                          Align(
                            ...
                            child: Padding(
                              ...
                              child: Text(paginatedCategorias[x].descricao,
                                  textAlign:
                                      TextAlign.left,
                                  ...
                                  ElevatedButton(
                                    onPressed: () {
                                      Navigator.pushNamed(
                                          ...
                                          arguments: paginatedCategorias[x]);
                                    },
