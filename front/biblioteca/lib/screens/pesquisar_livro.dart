  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      Provider.of<ExemplarProvider>(context, listen: false)
        ...
        setState(() {
          livros =
              Provider.of<ExemplarProvider>(context, listen: false).exemplares;
        });
      });
    });
                            ...
                            TableRow(
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: Text(filteredBooks[x].isbn,
                                      textAlign: TextAlign.center),
                                ),
                                Padding(
                                  padding: const EdgeInsets.only(
                                  ...
                                  child: Text(filteredBooks[x].titulo,
                                ...
                                Padding(
                                  ...
                                  child: Text(filteredBooks[x].editora,
                                      textAlign: TextAlign.center),
                                ),
                                Padding(
                                  padding: const EdgeInsets.only(
